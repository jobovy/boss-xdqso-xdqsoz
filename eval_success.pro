...
columns= [2,13,18,33,35,54,226]
truth= hogg_mrdfits('$BOSS_SPECTRO_REDUX/$RUN1D/spAll-$RUN1D.fits',1,columns=columns,/silent)
...
chunk= long(strtrim(strmid(truth.chunk,4),2))
